...
public class AbordagemPorClasses extends Artifact
{
    ...
    @OPERATION
    void executar_abrangente(String keyphrase, int limit, OpFeedbackParam<ArrayList<String>> result)
    {
    ...
    @OPERATION
    void executar_getIndividuos(ArrayList<String> classes, int limit_subclasses, OpFeedbackParam<String[]> result)
    {
