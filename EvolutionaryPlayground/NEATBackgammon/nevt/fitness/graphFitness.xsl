...
<body>
   ...
   <!--Draw and label vertical axis-->
    ...
    <svg:textPath dy="8" startOffset="94%" xlink:href="#fitness1"> 
            <xsl:value-of select="round(($fitness_range + $fitness_min))" />
        </svg:textPath>        
    </svg:text>

    <svg:path id="fitness21" stroke-width="0.5" stroke="green" fill="none" 
          d="M 40 70 L 540 70" />


    <svg:text fill="green" fill-opacity="1.0" font-size="9" font-family="Verdana">
   <svg:textPath dy="8" startOffset="90%" xlink:href="#fitness21"> 
            <xsl:value-of select="round(($fitness_range * 0.9) + $fitness_min)" />
        </svg:textPath>
    </svg:text>
    ...
    <svg:text fill="green" fill-opacity="1.0" font-size="9" font-family="Verdana">
   <svg:textPath dy="8" startOffset="80%" xlink:href="#fitness2"> 
            <xsl:value-of select="round(($fitness_range * 0.8) + $fitness_min)" />
        </svg:textPath>
    </svg:text>

    <svg:path id="fitness22" stroke-width="0.5" stroke="green" fill="none" 
          d="M 40 130 L 540 130" />


    <svg:text fill="green" fill-opacity="1.0" font-size="9" font-family="Verdana">
   <svg:textPath dy="8" startOffset="70%" xlink:href="#fitness22"> 
            <xsl:value-of select="round(($fitness_range * 0.7) + $fitness_min)" />
        </svg:textPath>
    </svg:text>
    ...
    <svg:text fill="green" fill-opacity="1.0" font-size="9" font-family="Verdana">
   <svg:textPath dy="8" startOffset="60%" xlink:href="#fitness3">
            <xsl:value-of select="round(($fitness_range * 0.6) + $fitness_min)" />
        </svg:textPath>
    </svg:text>

    <svg:path id="fitness23" stroke-width="0.5" stroke="green" fill="none" 
          d="M 40 190 L 540 190" />


    <svg:text fill="green" fill-opacity="1.0" font-size="9" font-family="Verdana">
   <svg:textPath dy="8" startOffset="50%" xlink:href="#fitness23">
            <xsl:value-of select="round(($fitness_range * 0.5) + $fitness_min)" />
        </svg:textPath>
    </svg:text>
    ...
    <svg:text fill="green" fill-opacity="1.0" font-size="9" font-family="Verdana">
    <svg:textPath dy="8" startOffset="40%" xlink:href="#fitness4"> 
            <xsl:value-of select="round(($fitness_range * 0.4) + $fitness_min)" />
        </svg:textPath>
    </svg:text>

    <svg:path id="fitness24" stroke-width="0.5" stroke="green" fill="none" 
          d="M 40 250 L 540 250" />      


    <svg:text fill="green" fill-opacity="1.0" font-size="9" font-family="Verdana">
    <svg:textPath dy="8" startOffset="30%" xlink:href="#fitness24"> 
            <xsl:value-of select="round(($fitness_range * 0.3) + $fitness_min)" />
        </svg:textPath>
    </svg:text>
    ...
    <svg:text fill="green" fill-opacity="1.0" font-size="9" font-family="Verdana">
   <svg:textPath dy="8" startOffset="20%" xlink:href="#fitness5"> 
            <xsl:value-of select="round(($fitness_range * 0.2) + $fitness_min)" />
        </svg:textPath>

    </svg:text>

    <svg:path id="fitness25" stroke-width="0.5" stroke="green" fill="none" 
          d="M 40 310 L 540 310" />
    <svg:text fill="green" fill-opacity="1.0" font-size="9" font-family="Verdana">
   <svg:textPath dy="8" startOffset="10%" xlink:href="#fitness25"> 
            <xsl:value-of select="round(($fitness_range * 0.1) + $fitness_min)" />
        </svg:textPath>
